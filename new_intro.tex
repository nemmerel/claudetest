...
Prior work capitalizes dividends and/or realized capital gains with a homogeneous cap factor. We use account-level brokerage data from Barber \& Odean (2000) to estimate heterogeneous dividend yields \textit{and} portfolio betas by 25 cells of age and income. Dividend yields increase linearly in age, with the 65+ group averaging 20\% higher yields than the under-35 group; conditional on age, they are weakly correlated with income. 
